...
Content() {
  ...
  el.innerHTML = `
    ...
    <div class="settings-version">Version ${GAME_VERSION}</div>
    <hr class="divider">
    <div class="action-row">
      <button class="seal-btn small" data-action="manual-save">💾 Save Now</button>
      <button class="seal-btn small steel" data-action="export-save">📥 Export Save</button>
      <button class="seal-btn small steel" data-action="trigger-import">📤 Import Save</button>
    </div>
    <hr class="divider">
    <div class="action-row">
...
function monsterTurn() {
  ...
  if (
    p.classId === 'warrior' &&
    p.level >= ABILITY_UNLOCK_LEVEL &&
    !c.secondWindUsed &&
    p.hp <= Math.round(stats.maxHp * 0.3)
  ) {
